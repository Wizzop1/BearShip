...
<div class="wrapper rounded bg-white">
  <div class="h3">Register</div>
   <div class="form">
    ...
    <div class="row">
            <div class="col-md-6 mt-md-0 mt-3"> <label>Full Name</label> <input type="text" class="form-control" name="fname" required> </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-md-0 mt-3"> <label>Repeat Password</label> <input type="password" class="form-control" name="cnfpsw" required> </div>
        </div>
        <div class="row">        
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-md-0 mt-3"> <label>Phone Number</label> <input type="number" name="tel" class="form-control" required> </div>
        </div>
        <div class="row">
            <div class="col-md-6 mt-md-0 mt-3"> <label>Deposit Money</label> <input type="number" name="money" class="form-control" required> </div>
            <div class="col-md-6 mt-md-0 mt-3"> <label>Address</label> <input type="text" name="address" class="form-control" required> </div>       
        </div>
...
function lengthDefine(inputtext, min, max){
	...
	if(uInput.length >= 6 && uInput.length <= max){
	return true;
	}else{
	document.getElementById('psw').innerText = "* Please enter between " +min+ " and " +max+ " characters *";
	inputtext.focus();
	return false;
	}
	}
...
function emailValidation(inputtext, alertMsg){
	...
	document.getElementById('email').innerText = alertMsg;
	inputtext.focus();
	return false;
	}
	}
